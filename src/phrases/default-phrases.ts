...
Regler utan email tas automatiskt bort.`,
    ...
    ADMIN_APP_SETTINGS_HEADLINE: 'Allmänna inställningar',
    ADMIN_APP_SETTINGS_BODY: 'Här kan du ändra de allmänna inställningarna.',
    ...
    EVENTLOG_CHART_OTHER: 'Övrigt',
    EVENTLOG_CHART_TITLE: 'Fördelning per händelsetyp',
    EVENTLOG_STATS_TITLE: 'Totalt vid uthämtning (advert-was-collected)',
    EVENTLOG_FILTER_NO_ORGANIZATION: 'Utan organisation',
