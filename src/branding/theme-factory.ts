...
export const getDefaultThemeModel = (): ThemeModel => {
    ...
    return {
        ...
        // Dark theme palette
        'dark.palette.primary': defaultDarkTheme.palette.primary.main,
        'dark.palette.secondary': defaultDarkTheme.palette.secondary.main,
        'dark.palette.error': defaultDarkTheme.palette.error.main,
        'dark.palette.warning': defaultDarkTheme.palette.warning.main,
        'dark.palette.info': defaultDarkTheme.palette.info.main,
        'dark.palette.success': defaultDarkTheme.palette.success.main,
        'dark.palette.background': defaultDarkTheme.palette.background.default,
        'dark.palette.paper': defaultDarkTheme.palette.background.paper,
        'dark.palette.text.primary': defaultDarkTheme.palette.text.primary,
        'dark.palette.text.secondary': defaultDarkTheme.palette.text.secondary,
        'dark.palette.text.disabled': defaultDarkTheme.palette.text.disabled,
